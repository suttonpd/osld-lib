 ...
 */
inline void hard_bpsk_demod(const cf* in, uint8_t* out, int N)
{
	int s;
 ...
 * \param modulation Modulation type
 */
inline void hard_qpsk_demod(const cf* in, uint8_t* out, int N)
{
	int s;
 ...
 * \param modulation Modulation type
 */
inline void hard_qam16_demod(const cf* in, uint8_t* out, int N)
{
	int s;
 ...
 * \param modulation Modulation type
 */
inline void hard_qam64_demod(const cf* in, uint8_t* out, int N)
{
	int s;
