...
void hard_bpsk_demod(const cf* in, uint8_t* out, int N);
void hard_qpsk_demod(const cf* in, uint8_t* out, int N);
void hard_qam16_demod(const cf* in, uint8_t* out, int N);
void hard_qam64_demod(const cf* in, uint8_t* out, int N);
